 ...
 if(!(isset($_SESSION['username']) && $_SESSION['username']!='')){ $src="/Public".$user_info['user_image']; echo '<div class="user_info">
         ...
         <div class="question">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#guanzhu" role="tab" data-toggle="tab">他的关注</a></li>
                        </ul>
                    ...
                    <ul class="question-taglist">'; if($value['C']==1){ echo '<li><span class="label label-primary tag-button"><a href="/index.php/home/search/searchtag?id=1" class="tag-click">C</a></span> </li>'; } if($value['JAVA']==1){ echo '<li><span class="label label-primary tag-button"><a href="/index.php/home/search/searchtag?id=2" class="tag-click">JAVA</a></span> </li>'; } if($value['PHP']==1){ echo '<li><span class="label label-primary tag-button"><a href="/index.php/home/search/searchtag?id=3" class="tag-click">PHP</a></span> </li>'; } echo '</ul>
                            ...
                            '; } echo '</div>
                            <div role="tabpanel" class="tab-pane" id="guanzhu">'; foreach ($user_data as $key => $value) { $src="/Public".$value['user_image']; echo '<section class="user-list-section">
            ...
            <div class="user_info_main">
                ...
                <div class="body clearfix">
                    ...
                    <div class="info_content">'; $guanzhu_temp=false; $guanzhu_list=$_SESSION['guanzhu']; foreach ($guanzhu_list as $key => $value) { if($value['user_id2']==$user_info['id']){ $guanzhu_temp=true; } } if($guanzhu_temp){ echo '<button  class="btn btn-success modify_info "  onclick="quguan()">已关注</button>'; }else{ echo ' <button  class="btn btn-success modify_info "  onclick="guanzhu()">关注</button>'; } echo '<form>
                    <input type="hidden" name="hidden_name1" id="hidden_name1" value=" '.$user_info['id'].'">
                    <input type="hidden" name="hidden_name2" id="hidden_name2" value=" '.$_SESSION['id'].'">
                    </form>
                        <div class="sex">
                            <strong class="sex_name">性别:</strong>
                            <strong class="sex_info">'.$user_info['sex'].'</strong>
         ...
         <div class="question">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#guanzhu" role="tab" data-toggle="tab">我的关注</a></li>
                        </ul>
